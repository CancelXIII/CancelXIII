x = "2hello2  .100"
# build space spicific and default all, and also for allalpha
# build split for litter and not alpha
def cletip(str_= None, specific_str = None,specific_type:bool= None):
    ...
    return x2
def rletip(str_= None, specific_str = None,specific_type:bool= None):
    if specific_type is None:
        specific_type = True
    elif specific_type != True and specific_type != False:
        specific_type = True
    ...
    return x2
def lletip(str_= None, specific_str = None,specific_type:bool= None):
    if specific_type is None:
        specific_type = True
    elif specific_type != True and specific_type != False:
        specific_type = True
    ...
    return x2
def letip(str_= None, specific_str = None,specific_type:bool= None):
    if specific_type is None:
        specific_type = True
    elif specific_type != True and specific_type != False:
        specific_type = True
